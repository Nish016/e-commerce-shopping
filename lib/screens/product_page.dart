...
class _ProductPageState extends State<ProductPage> {
  ...
  //Whenever you select a product it will have the product id
  //The if we call this function it will go to the user ref in collection inside it a doc
  //Inside that we will have a cart collection and the product id of the current product
